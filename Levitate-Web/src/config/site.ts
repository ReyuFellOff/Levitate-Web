import {
  Shield, Zap, Sparkles, Bell, Layers, Settings, MoreHorizontal,
  ...
  commandCategories: [
    {
      ...
      commands: [
        ...
        { name: '$invite',      aliases: ['addbot', 'botinvite', 'inv'], permission: null, description: 'Get the link to add this bot to your server and join the support server.', usage: '$invite' },
        { name: '$node-status', aliases: ['nodestatus', 'ns'],         permission: null, description: 'Show which Lavalink node is connected and list all configured nodes in priority order.', usage: '$node-status' },
    ...
    },
    {
      ...
      commands: [
        ...
        { name: '$nick',           aliases: ['nickname'],                           permission: 'Manage Nicknames',  description: 'Change a member\'s nickname, or reset up to 10 members at once.',  usage: '$nick <@user|ID> <new nickname>\n$nick reset <user1> [user2] ... [user10]' },
        { name: '$massnick',       aliases: ['massnickname'],                       permission: 'Manage Nicknames',  description: 'Mass-change nicknames with prepend, append, remove, or reset. A 6-button panel lets you target All Members / Humans Only / Bots Only / Specific Role (dropdown) / Members (type them) / Cancel.', usage: '$massnick prepend <word>\n$massnick append <word>\n$massnick remove <word>\n$massnick reset' },
    ...
    },
    {
      ...
      commands: [
        ...
        { name: '$vanity',           aliases: [],                                    permission: null,             description: 'Show this server\'s vanity URL when used without an argument, or check whether another vanity is taken or available.', usage: '$vanity [url]' },
        ...
        { name: '$say',              aliases: ['echo'],                               permission: 'Manage Messages', description: 'Make the bot say something in the current channel. Supports \\n for newlines, custom emoji syntax, and file attachments. Also works as a reply.', usage: '$say <text>' },
        { name: '$serverinfo',  aliases: ['si', 'guildinfo', 'guild'],   permission: null,             description: '5-tab panel: Overview (including the server vanity when configured) · Members · Channels · Security · Assets.', usage: '$serverinfo' },
    ...
    },
    {
      ...
      icon: Layers,
      commands: [
        { name: '$starboard',    aliases: ['stars'],                         permission: 'Manage Server', description: 'Configure a live reaction starboard with thresholds, custom emoji, ignore lists, manual sync, and an interactive CV2 status panel.', usage: '$starboard\n$starboard channel <#channel>\n$starboard threshold <number>\n$starboard emoji <emoji>\n$starboard color <#hex>\n$starboard ignore <add|remove> <#channel|@role>\n$starboard config\n$starboard toggle <on|off>\n$starboard top\n$starboard sync [<#channel>]' },
        { name: '$randomstar',   aliases: ['randomstars', 'randomstarboard'], permission: null,            description: 'Show a random historical starboard post.', usage: '$randomstar' },
        ...
        { name: '$customrole create',  aliases: ['cr', 'crole'], permission: 'Administrator', description: 'Register a keyword and link up to 5 roles. All custom-role keywords use the server-wide access role configured with `$customrole access`. Max 15 keywords per server. Does not work with noprefix.', usage: '$customrole create <keyword> <@role> [@role2 …]' },
        { name: '$customrole access',   aliases: ['cr', 'crole'], permission: 'Administrator', description: 'Set the single access role required to use every custom-role keyword in this server. Server owners bypass it.', usage: '$customrole access <@role>' },
        { name: '$customrole delete',  aliases: ['cr', 'crole'], permission: 'Administrator', description: 'Remove a custom role keyword from the server.',                                                                                                                                                     usage: '$customrole delete <keyword>' },
        { name: '$customrole list',    aliases: ['cr', 'crole'], permission: 'Administrator', description: 'Show all custom role keywords configured in this server and the single server-wide access role.',                                                                                                      usage: '$customrole list' },
        { name: '$customrole info',    aliases: ['cr', 'crole'], permission: 'Administrator', description: 'Show the roles linked to a specific keyword and the server-wide custom-role access role.',                                                                                                           usage: '$customrole info <keyword>' },
        { name: '$customrole add',     aliases: ['cr', 'crole'], permission: 'Administrator', description: 'Link additional roles to an existing keyword (max 5 total per keyword).',                                                                                                                         usage: '$customrole add <keyword> <@role> [@role2 …]' },
        { name: '$customrole remove',  aliases: ['cr', 'crole'], permission: 'Administrator', description: 'Unlink specific roles from a keyword. If the last role is removed, the keyword is deleted.',                                                                                                    usage: '$customrole remove <keyword> <@role> [@role2 …]' },
    ...
    },
    {
      ...
      icon: Heart,
      commands: [
        { name: '$customise',    aliases: ['customize'],         permission: 'Administrator', description: 'Interactive profile panel: edit the bot\'s name, bio, avatar, and banner; set the namestyle; or reset to global defaults. Session active 10 minutes.', usage: '$customise' },
