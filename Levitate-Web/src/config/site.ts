  ...
  commandCategories: [
    ...
    },
    {
      ...
      commands: [
        ...
        { name: '$massnick',       aliases: ['massnickname', 'mn'],                 permission: 'Manage Nicknames',  description: 'Mass-change nicknames with prepend, append, remove, or reset. A button panel lets you choose All Members / Humans Only / Bots Only.', usage: '$massnick prepend <word>\n$massnick append <word>\n$massnick remove <word>\n$massnick reset' },
